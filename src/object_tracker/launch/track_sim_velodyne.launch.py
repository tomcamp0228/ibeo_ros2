#This file is launched for ROS2 bag recorded with Velodyne LiDAR
import os
import launch
...
def generate_launch_description():
    ...
    para_dir = os.path.join(get_package_share_directory('object_tracker'), 'config', 'para_track_sim_velodyne.yaml')
