...
public:
	...
	luxObjectClass::LuxObjectClass getClassification() const { return m_classification; }
...
public:
	...
	void setClassification(const luxObjectClass::LuxObjectClass newClassification) { m_classification = newClassification; }
...
protected:
	...
	luxObjectClass::LuxObjectClass m_classification; // as uint8_t
