...
double Measurement::getAs<double>() const
{
	...
	case TypeVoid:
		throw std::runtime_error("Not able to convert from void to float");
	case TypeFloat:    return static_cast<double>(getData<double>());
...
INT8 Measurement::getAs<INT8>() const
{
	...
	case TypeFloat:    return static_cast<INT8>(getData<double>());
...
UINT8 Measurement::getAs<UINT8>() const
{
	...
	case TypeFloat:    return static_cast<UINT8>(getData<double>());
...
INT16 Measurement::getAs<INT16>() const
{
	...
	case TypeFloat:    return static_cast<INT16>(getData<double>());
...
UINT16 Measurement::getAs<UINT16>() const
{
	...
	case TypeFloat:    return static_cast<UINT16>(getData<double>());
...
INT32 Measurement::getAs<INT32>() const
{
	...
	case TypeFloat:    return static_cast<INT32>(getData<double>());
...
UINT32 Measurement::getAs<UINT32>() const
{
	...
	case TypeFloat:    return static_cast<UINT32>(getData<double>());
...
INT64 Measurement::getAs<INT64>() const
{
	...
	case TypeFloat:    return static_cast<INT64>(getData<double>());
...
UINT64 Measurement::getAs<UINT64>() const
{
	...
	case TypeFloat:    return static_cast<UINT64>(getData<double>());
...
bool Measurement::getAs<bool>() const
{
	...
	case TypeFloat:    return static_cast<bool>(getData<double>());
	case TypeDouble:   return static_cast<bool>(getData<double>());
	case TypeINT8:     return static_cast<bool>(getData<INT8>());
	case TypeUINT8:    return static_cast<bool>(getData<UINT8>());
	case TypeINT16:    return static_cast<bool>(getData<INT16>());
	case TypeUINT16:   return static_cast<bool>(getData<UINT16>());
	case TypeINT32:    return static_cast<bool>(getData<INT32>());
	case TypeUINT32:   return static_cast<bool>(getData<UINT32>());
	case TypeINT64:    return static_cast<bool>(getData<INT64>());
	case TypeUINT64:   return static_cast<bool>(getData<UINT64>());
